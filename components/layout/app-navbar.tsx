...
import { BellDot, PanelLeftClose, PanelLeftOpen, ShieldCheck } from "lucide-react";
      ...
      <div className="flex min-h-20 flex-col gap-4 px-4 py-4 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        <div className="flex min-w-0 items-center gap-3 lg:w-56">
          <Button
            ...
            className="hidden h-10 w-10 rounded-2xl border-slate-200/80 bg-white/90 shadow-sm transition-transform duration-300 hover:-translate-y-0.5 hover:bg-amber-50 dark:border-slate-800 dark:bg-slate-900/90 dark:hover:bg-slate-800 lg:inline-flex"
